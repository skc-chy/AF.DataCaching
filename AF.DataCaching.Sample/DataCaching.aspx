<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DataCaching.aspx.cs" Inherits="AFDataCaching.DataCachingDemo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width:100%;border-style:inset;border-color:Blue;border-width:thin;">
        <span style="font-size: small">POI : Please check implementation details of Data Caching
            in class 'DataCachingDAL.cs'</span>
    </div>
    <br />
    <br />
    <table>
